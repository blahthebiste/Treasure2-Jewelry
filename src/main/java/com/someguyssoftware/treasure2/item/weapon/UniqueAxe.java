...
public class UniqueAxe extends Axe {
    public UniqueAxe(String id, String name, ToolMaterial material, Item repairItem, float damageModifier, float speedModifier, CreativeTabs tab) {
        super(id, name, material, repairItem, damageModifier, speedModifier, tab);
    }

    public UniqueAxe(String id, String name, ToolMaterial material, Item repairItem, float damageModifier, float speedModifier, double criticalChance, float criticalDamage, CreativeTabs tab) {
