...
// TODO almost everything in here is repeated between concrete classes and could be abstracted out.
/**
 *
 * @author Mark Gottschling on July 28, 2024
 *
 */
public class DeferredSurfaceGeneratorBlockEntity extends BlockEntity implements IChestFeature {
    ...
    public void tickServer() {
        if (Config.SERVER.markers.enableSpawner.get()) {
            ...
            try {
                ...
                IFeatureGenerator featureGenerator = TreasureFeatureGenerators.SURFACE_STRUCTURE_FEATURE_GENERATOR;
