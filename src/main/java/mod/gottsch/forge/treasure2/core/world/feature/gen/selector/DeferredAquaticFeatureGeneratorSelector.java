 ...
 *
 */
public class DeferredAquaticFeatureGeneratorSelector implements IFeatureGeneratorSelector {

	@Override
	public IFeatureGenerator select() {
		return TreasureFeatureGenerators.DEFERRED_SUBAQUATIC_FEATURE_GENERATOR;
	}
}
